...
public class QstRecycleAdapter extends RecyclerView.Adapter<QstRecycleAdapter.ViewHolder>{


    public List<QuestionPost> blogList;
    ...
    public QstRecycleAdapter(List<QuestionPost> blog_list){
